 ...
 */
package hotel.management.system.imt.bookRoom;
...
public class BookRoomController implements Initializable {
 ...
 JFXAutoCompletePopup<String> autoCompletePopup = new JFXAutoCompletePopup<>();
    ...
    private void handleOkAction(ActionEvent event) {
         ...
         if(registerdCustomer){
           for(String roomId:roomNo){
             bookRoom(roomId, customerId, customerName, Integer.parseInt(guest), checkIn, checkOut, bookType);
         }  
         }else{
    ...
    private void bookRoom(String RoomNo, String customerId, String customerName, int guests, String checkIn, String checkOut, String type){
        String qu = "INSERT INTO BOOK(room_id, customer_id, customer_name, guests, check_in, check_out, type) VALUES ("
        + "'" + RoomNo + "',"
        + "'" + customerId + "',"
        + "'" + customerName + "',"
        + guests + ","
    ...
    private void addnewCustomer(String id, String name, String address, String mobile, String email, String category, String[] RoomNo, int guests, String checkIn, String checkOut, String type){
        ...
        alert.showAndWait();*/
        for(String roomId:RoomNo){
             bookRoom(roomId, id, name, guests, checkIn, checkOut, type);
         }
