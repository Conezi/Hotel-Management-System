 ...
 */
package hotel.management.system.imt.addroom;
...
import hotel.management.system.imt.main.Room;
...
public class AddRoomController implements Initializable {
    ...
    private void addRoom(ActionEvent event) {
         if (room_no.getText().isEmpty() || bed_count.getText().isEmpty() || room_category.getSelectionModel().isEmpty()||(other_assets.getText().isEmpty()&&asset_chip.getChips().get(0).isEmpty())) {
