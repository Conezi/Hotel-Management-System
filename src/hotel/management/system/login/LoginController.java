 ...
 */
package hotel.management.system.login;

import com.jfoenix.controls.JFXPasswordField;
import com.jfoenix.controls.JFXTextField;
import hotel.management.system.constants.ConstantStrings;
...
public class LoginController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        titleLabel.setText(ConstantStrings.AppName);
    }    
    ...
    void loadMain() {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/hotel/management/system/main/Main.fxml"));
            Stage stage = new Stage(StageStyle.DECORATED);
            stage.setTitle(ConstantStrings.AppName);
